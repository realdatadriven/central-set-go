...
- [Create dashboards](https://realdatadriven.github.io/central-set-go/docs/tutorials/dashboards/) and reports using Markdown + DuckDB-WASM ([evidence.dev](hhttps://legacy-docs.evidence.dev) style)
