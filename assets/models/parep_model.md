    ...
    menu_config: |
      {
        ...
        "load_items": {
          ...
          "tables": ["objetivos", "resultados", "indicadores", "resultado_anos", "acoes", "logistica"]
        }
      }
    tables:
      - objetivos
...
columns:
  ...
  user_id: { type: integer, comment: "Utilizador", tooltip: "Utilizador responsável pelo registo." }
  created_at: { type: datetime, comment: "Criado em", tooltip: "Data e hora de criação.", table_display: true }
  updated_at: { type: datetime, comment: "Atualizado em", tooltip: "Data e hora da última atualização.", table_display: true }
  excluded: { type: boolean, default: false, comment: "Excluído", tooltip: "Indica se o registo está excluído." }
form_layout:
  tabs_steps: tabs
  form_in_popup: true
  size: 3
...
columns:
  ...
  ano: { type: varchar, len: 4, nullable: false, unique: true, comment: "Ano", tooltip: "Ano civil ou de referência.", form_display: true, table_display: true, form_size: 4, order: 2 }
...
columns:
  objetivo_id: { type: integer, pk: true, autoincrement: true, comment: "ID", tooltip: "Identificador único do objetivo." }
  objetivo: { type: varchar, len: 255, nullable: false, comment: "Objetivo", tooltip: "Nome do objetivo estratégico.", form_display: true, table_display: true, form_size: 8, order: 1 }
  ...
  status_id: { type: integer, comment: "Estado", tooltip: "Estado do objetivo.", form_display: true, table_display: true, form_size: 4, form_order: 2 }
  user_id: { type: integer, comment: "Utilizador", tooltip: "Utilizador responsável pelo registo." }
  created_at: { type: datetime, comment: "Criado em", tooltip: "Data e hora de criação.", table_display: true }
  updated_at: { type: datetime, comment: "Atualizado em", tooltip: "Data e hora da última atualização.", table_display: true }
  excluded: { type: boolean, default: false, comment: "Excluído", tooltip: "Indica se o registo está excluído." }
...
columns:
  resultado_id: { type: integer, pk: true, autoincrement: true, comment: "ID", tooltip: "Identificador do resultado esperado." }
  resultado: { type: varchar, len: 255, nullable: false, comment: "Resultado Esperado", tooltip: "Nome do resultado esperado.", form_display: true, table_display: true, form_size: 8, order: 1 }
  ...
  status_id: { type: integer, comment: "Estado", tooltip: "Estado do resultado esperado.", form_display: true, table_display: true, form_size: 4, form_order: 2 }
  user_id: { type: integer, comment: "Utilizador", tooltip: "Utilizador responsável pelo registo." }
  created_at: { type: datetime, comment: "Criado em", tooltip: "Data e hora de criação.", table_display: true }
  updated_at: { type: datetime, comment: "Atualizado em", tooltip: "Data e hora da última atualização.", table_display: true }
  excluded: { type: boolean, default: false, comment: "Excluído", tooltip: "Indica se o registo está excluído." }
...
columns:
  ...
  resultado_ano: { type: varchar, len: 255, nullable: false, comment: "Desc. Resultado Ano", tooltip: "Desc Ano resultado esperado.", form_display: true, table_display: true, form_size: 8, order: 1 }
  ...
  orcamento_ano: { type: decimal, len: 14, scale: 2, default: 0, comment: "Orcamento anual", form_display: true, table_display: true, form_size: 4, order: 8 }
  user_id: { type: integer, comment: "Utilizador", tooltip: "Utilizador responsável pelo registo." }
  created_at: { type: datetime, comment: "Criado em", tooltip: "Data e hora de criação.", table_display: true }
  updated_at: { type: datetime, comment: "Atualizado em", tooltip: "Data e hora da última atualização.", table_display: true }
  excluded: { type: boolean, default: false, comment: "Excluído", tooltip: "Indica se o registo está excluído." }
...
columns:
  acao_id: { type: integer, pk: true, autoincrement: true, comment: "ID", tooltip: "Identificador da ação."}
  acao: { type: varchar, len: 255, nullable: false, comment: "Ação", tooltip: "Nome da ação.", form_display: true, table_display: true, form_size: 8, order: 1 }
  acao_desc: { type: text, comment: "Descrição", tooltip: "Descrição da ação.", form_display: true, table_display: true, form_long_text: true, form_size: 12, order: 4 }
  data_ini: { type: date, comment: "Data início", tooltip: "Data de início da ação.", form_display: true, table_display: true, form_size: 4, order: 5 }
  data_fim: { type: date, comment: "Data fim", tooltip: "Data de fim da ação.", form_display: true, table_display: true, form_size: 4, order: 6 }
  orcamento_estimado: { type: decimal, len: 14, scale: 2, default: 0, comment: "Orçamento estimado", tooltip: "Valor estimado da ação.", form_display: true, table_display: true, form_size: 4, order: 7 }
  orcamento_executado: { type: decimal, len: 14, scale: 2, default: 0, comment: "Orçamento executado", tooltip: "Valor executado da ação.", form_display: true, table_display: true, form_size: 4, order: 8 }
  status_id: { type: integer, fk: "status_acao.status_acao_id", comment: "Status", tooltip: "Estado atual da ação.", form_display: true, table_display: true, form_size: 4, order: 9 }
  resultado_ano_id: { type: integer, fk: "resultado_anos.resultado_ano_id", comment: "Resultado Esperado Ano", tooltip: "Relação com a execução anual do resultado esperado.", form_display: true, table_display: true, form_size: 4, order: 10 }
  ano_id: { type: integer, fk: "anos.ano_id", nullable: false,  comment: "Ano", tooltip: "Ano da ação for referência.", form_display: true, table_display: true, form_size: 4, order: 11 }
  resultado_id: { type: integer, fk: "resultados.resultado_id", comment: "Resultado Esperado", tooltip: "Resultado esperado associado.", form_display: true, table_display: true, form_size: 2, form_order: 2 }
  objetivo_id: { type: integer, fk: "objetivos.objetivo_id", comment: "Objetivo", tooltip: "Objetivo associado.", form_display: true, table_display: true, form_size: 2, form_order: 3 }
  user_id: { type: integer, comment: "Utilizador", tooltip: "Utilizador responsável pelo registo." }
  created_at: { type: datetime, comment: "Criado em", tooltip: "Data e hora de criação.", table_display: true }
  updated_at: { type: datetime, comment: "Atualizado em", tooltip: "Data e hora da última atualização.", table_display: true }
  excluded: { type: boolean, default: false, comment: "Excluído", tooltip: "Indica se o registo está excluído." }
...
columns:
  ...
  ano_id: { type: integer, fk: "anos.ano_id", nullable: false,  comment: "Ano", tooltip: "Ano do contrato.", form_display: true, table_display: true, form_size: 4, order: 12 }
...
columns:
  ...
  ano_id: { type: integer, fk: "anos.ano_id", nullable: false,  comment: "Ano", tooltip: "Ano da logística.", form_display: true, table_display: true, form_size: 4, order: 8 }
...
columns:
  ...
  resultado_ano_id: { type: integer, fk: "resultado_anos.resultado_ano_id", comment: "Resultado Esperado Ano", tooltip: "Resultado esperado anual associado.", form_display: true, table_display: true, form_size: 6, order: 7 }
  ano_id: { type: integer, fk: "anos.ano_id", nullable: false,  comment: "Ano", tooltip: "Ano de referência.", form_display: true, table_display: true, form_size: 4, order: 8 }
  resultado_id: { type: integer, fk: "resultados.resultado_id", comment: "Resultado Esperado", tooltip: "Resultado esperado principal.", form_display: true, table_display: true, form_size: 4, order: 9 }
  objetivo_id: { type: integer, fk: "objetivos.objetivo_id", comment: "Objetivo", tooltip: "Objetivo associado.", form_display: true, table_display: true, form_size: 4, order: 10 }
  user_id: { type: integer, comment: "Utilizador", tooltip: "Utilizador responsável pelo registo." }
  created_at: { type: datetime, comment: "Criado em", tooltip: "Data e hora de criação.", table_display: true }
...
table: indicadores
comment: Indicadores
tooltip: Indicadores de resultado ou de acompanhamento do desempenho do programa.
columns:
