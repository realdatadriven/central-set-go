...
intended to be used together with a business model such as `STORE`: UI owns
...
columns:
  ui_id:          { type: integer, pk: true, autoincrement: true, comment: "Dynamic UI ID" }
...
form_layout:
  ...
  form_in_popup: false
  size: 9
  allow_in_subform: {ui_route: true, ui_page: true, ui_partial: true, ui_asset: true, ui_navigation: true, ui_setting: true}
  tabs_steps_conf:
...
table_layout:
  default_order: [{field: ui_partial, order: ASC}]
```
...
form_layout:
  ...
  tabs_steps_conf:
    - {label: Page, fields: [ui_id, page_key, page_title, meta_description, cache_seconds, active]}
...
columns:
  ui_route_id: { type: integer, pk: true, autoincrement: true, comment: "Route ID" }
  ui_id:       { type: integer, fk: "dynui.ui_id", nullable: false, comment: "Website", form_display: true, table_display: true, form_size: 3, order: 1 }
  ...
  ui_page_id:  { type: integer, fk: "ui_page.ui_page_id", nullable: false, comment: "Page", form_display: true, table_display: true, form_size: 3, order: 5 }
...
form_layout:
  size: 9
table_layout:
  default_order: [{field: ui_page_data, order: ASC}]
```
...
columns:
  ui_navigation_id: { type: integer, pk: true, autoincrement: true, comment: "Navigation ID" }
  ui_id:            { type: integer, fk: "dynui.ui_id", nullable: false, comment: "Website", form_display: true, table_display: true, form_size: 3, order: 1 }
  parent_id:           { type: integer, fk: "ui_navigation.ui_navigation_id", comment: "Parent Item", form_display: true, table_display: true, form_size: 3, order: 2 }
...
columns:
  ui_setting_id: { type: integer, pk: true, autoincrement: true, comment: "Setting ID" }
  ui_id:         { type: integer, fk: "dynui.ui_id", nullable: false, comment: "Website", form_display: true, table_display: true, form_size: 3, order: 1 }
...
context and parse the page template plus every active `ui_partial` in a
single `html/template.Template` set. Recommended context keys are:

```text
.Site       # dynui row, public ui_setting values and navigation tree
.Page       # selected ui_page row
.Route      # route row, PathParams and Query
.Data       # each ui_page_data result under its ui_page_data name
