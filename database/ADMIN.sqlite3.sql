...
CREATE TABLE IF NOT EXISTS "flight_schema" (
	...
	"table_scan_tmpl_sql"	TEXT, flight_schema_conf text null,
...
CREATE TABLE IF NOT EXISTS flight_schema_table_scope (
	flight_schema_table_scope_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, 
	flight_schema_table_scope VARCHAR(200) NOT NULL, 
	flight_schema_table_scope_desc TEXT, 
	flight_schema_table_scope_sql TEXT NOT NULL, 
	flight_schema_table_id INTEGER, 
	flight_schema_id INTEGER, 
	active BOOLEAN, 
	user_id INTEGER, 
	...
	updated_at DATETIME, 
	excluded BOOLEAN, 
	UNIQUE (flight_schema_table_scope), 
	FOREIGN KEY(flight_schema_table_id) REFERENCES flight_schema_table (flight_schema_table_id), 
	FOREIGN KEY(flight_schema_id) REFERENCES flight_schema (flight_schema_id), 
	FOREIGN KEY(user_id) REFERENCES users (user_id), 
	FOREIGN KEY(app_id) REFERENCES app (app_id)
