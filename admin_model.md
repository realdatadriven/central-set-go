...
comment: CRUD Action Logs
columns:
  batch_process_log_id: { type: integer, pk: true, autoincrement: true, comment: "CRUD Action Log ID" }
  batch_process_id:     { type: integer, fk: "batch_process.batch_process_id", comment: "CRUD Action ID", order: 1 }
  batch_process_code:   { type: varchar(200), comment: "CRUD Action Code", order: 2 }
  batch_process:        { type: varchar(200), comment: "CRUD Action Name", order: 3 }
  db:                 { type: varchar(200), comment: "Database", order: 5 }
