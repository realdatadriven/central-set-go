...
cs_app:
  ...
  Workflow:
    ...
    menu_order: 3
    active: true
    menu_config: '{"label": "workflow_instance", "tooltip": "workflow_desc", "load_items": {"table": "workflow_instance", "tables": ["workflow_instance"]}}'
    tables:
      - {table: workflow_instance, requires_rla: true, active: true}
...
columns:
  ...
  workflow: { type: varchar, length: 200, unique: true, nullable: false, comment: "Workflow", tooltip: "Name of the workflow", form_display: true, table_display: true, form_size: 6  }
  ...
  version: { type: varchar, length: 200, default: 'v1.0.0', comment: "Version", tooltip: "Version number of the workflow", form_display: true, table_display: true, form_size: 3  }
  ...
  schedule: { type: varchar, length: 200, comment: "Cron Schedule", tooltip: "Cron Representation of when it runs, if so", form_display: true, table_display: true, form_size: 6  }
  steps_orientation: { type: varchar, length: 200, comment: "Step Orientation", tooltip: "Vertical / Horizontal", form_display: true, table_display: true, form_size: 6  }
  workflow_icon: { type: varchar, length: 200, comment: "Icon", tooltip: "Workflow Icon", form_display: true, table_display: true, form_size: 6  }
...
columns:
  ...
  step: { type: varchar, length: 200, nullable: false, comment: "Step", tooltip: "Name of the step", form_display: true, table_display: true  }
  ...
  step_icon: { type: varchar, length: 200, comment: "Icon", tooltip: "Step Icon", form_display: true, table_display: true, form_size: 6  }
  step_color: { type: varchar, length: 200, comment: "Color", tooltip: "Step Color", form_display: true, table_display: true, form_size: 6  }
  ...
  app_id: { type: integer, comment: "App ID", tooltip: "Identifier of the application context" }
  api: { type: varchar, length: 255, comment: "API", tooltip: "API that is called", form_display: true, table_display: false  }
...
columns:
  ...
  name: { type: varchar, length: 200, nullable: false, comment: "Name", tooltip: "Name of the SLA rule", form_display: true, table_display: true }
  ...
  priority: { type: varchar, length: 50, comment: "Priority", tooltip: "Priority level for the SLA", form_display: true }
...
columns:
  ...
  name: { type: varchar, length: 200, nullable: false, comment: "Name", tooltip: "Name of the step SLA rule", form_display: true, table_display: true }
  description: { type: text, comment: "Description", tooltip: "Description of the step SLA rule", form_display: true }
  duration_hours: { type: integer, nullable: false, comment: "Duration Hours", tooltip: "SLA duration in hours", form_display: true, table_display: true }
  escalation_hours: { type: integer, comment: "Escalation Hours", tooltip: "Hours before escalation is triggered", form_display: true }
  priority: { type: varchar, length: 50, comment: "Priority", tooltip: "Priority level for the step SLA", form_display: true }
...
columns:
  ...
  name: { type: varchar, length: 200, nullable: false, comment: "Name", tooltip: "Name of the department", form_display: true, table_display: true }
...
columns:
  ...
  field: { type: varchar, length: 200, nullable: false, comment: "Field", tooltip: "Technical identifier of the field", form_display: true, table_display: true  }
  label: { type: varchar, length: 200, nullable: false, comment: "Label", tooltip: "Display name of the field", form_display: true, table_display: true  }
  data_type: { type: varchar, length: 50, nullable: false, comment: "Data Type", tooltip: "Type of data stored in the field", form_display: true  }
  nullable: { type: boolean, default: true, comment: "Nullable", tooltip: "Indicates whether the field can be empty", form_display: true  }
  default_value: { type: varchar, length: 200, comment: "Default Value", tooltip: "Default value assigned to the field" }
  validation_rule: { type: varchar, length: 200, comment: "Validation Rule", tooltip: "Regex validation rulw for the field" }
  ...
  format: { type: varchar, length: 200, comment: "Format", tooltip: "Format intl.Format" }
...
columns:
  ...
  option_value: { type: varchar, length: 200, nullable: false, comment: "Option Value", tooltip: "Stored value representing the option", form_display: true, table_display: true  }
  option_label: { type: varchar, length: 200, nullable: false, comment: "Option Label", tooltip: "Display label of the option", form_display: true, table_display: true  }
...
columns:
  ...
  email: { type: varchar, length:100, comment: "Email", tooltip: "Email associated with the responsibility" }
  ...
  role: { type: varchar, length:100, comment: "Role", tooltip: "Role associated with the responsibility" }
...
columns:
  ...
  subscriber_type: { type: varchar, length: 50, comment: "Subscriber Type", tooltip: "Type of subscriber (responsible, observer, stakeholder, etc.)", form_display: true, table_display: true }
...
columns:
  ...
  status:      { type: varchar, length: 4, unique: true, nullable: false, comment: "Language", form_display: true, table_display: true, order: 1 }
  status_desc: { type: varchar, length: 200, comment: "Description", form_display: true, table_display: true, order: 2 }
...
columns:
  ...
  field: { type: varchar, length: 200, nullable: false, comment: "Field", tooltip: "Technical identifier of the field", table_display: true  }
...
columns:
  ...
  action: { type: varchar, length: 50, nullable: false, comment: "Action", tooltip: "Type of action performed" }
  status_from: { type: varchar, length: 50, comment: "Status From", tooltip: "Status before the action" }
  status_to: { type: varchar, length: 50, comment: "Status To", tooltip: "Status after the action", table_display: true  }
...
columns:
  ...
  notification_type: { type: varchar, length: 50, nullable: false, comment: "Notification Type", tooltip: "Type of notification (step_started, step_completed, escalation, etc.)", form_display: true, table_display: true }
  subject: { type: varchar, length: 255, comment: "Subject", tooltip: "Email subject or notification title", form_display: true, table_display: true }
  ...
  delivery_status: { type: varchar, length: 50, default: "pending", comment: "Delivery Status", tooltip: "Status of delivery (pending, sent, failed, bounced)", form_display: true, table_display: true }
