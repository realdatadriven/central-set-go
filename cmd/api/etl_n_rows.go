...
func (app *application) _n_rows(_item map[string]interface{}, _conf map[string]interface{}, _etlrb map[string]interface{}, _conf_etlrb map[string]interface{}, db_conf map[string]interface{}, _step map[string]interface{}) map[string]interface{} {
	...
	_sql := fmt.Sprintf(`SELECT COUNT(*) AS "n_rows" FROM %s."%s"`, _db_name_no_ext, destination_table)
