...
func (q *QueryDoc) GetQuerySQL() string {
	...
	return fmt.Sprintf("%s%s%s%s%s%s%s%s",
		query.Select, query.From, query.Join, query.Where,
...
func (q *QueryDoc) GetQuerySQLFromMap() string {
	...
	return fmt.Sprintf("%s%s%s%s%s%s%s%s", query.Select, query.From, query.Join, query.Where, query.GroupBy, query.Window, query.OrderBy, query.Having)
}
